...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($token) {
        ...
        if ($expired >= $currentDate && $payload['role']) {
            ...
            $query = "INSERT INTO request (id, user_id, name, total, created_at) VALUES ('$uuid', '$userId', '$name', '$total', '$currentDate')";
            ...
            if ($data === true) {
                ...
                echo json_encode(array('success' => true, 'message' => 'Successfully create request'),);
            } else {
                http_response_code(404);
                echo json_encode(array('success' => false, 'message' => 'Failed create request'));
            }
        } else {

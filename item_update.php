...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($token) {
        ...
        if ($expired >= $currentDate && $payload['role']) {
            ...
            $query = "UPDATE items SET name='$name', total='$total' WHERE id='$id'";
            ...
            if ($data == true) {
                ...
                echo json_encode(array('success' => true, 'message' => 'Successfully update item'),);
            } else {
                http_response_code(404);
                echo json_encode(array('success' => false, 'message' => 'Failed update item'),);
            }
        } else {
